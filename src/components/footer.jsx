...
function Footer() {
  return (
    <footer className="bg-gray-300 shadow-lg shadow-green-700 flex flex-col sm:flex-row justify-around items-center mt-5 pt-4 gap-4 sm:gap-0 w-full">
      <div>
        <p className="font-bold text-base flex gap-2"><FaWallet className="text-green-600" />Flexible payment</p>

        <p className="text-base text-stone-700">Multiple secure payment options</p>
      </div>
      <div>
